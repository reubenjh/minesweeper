...
/* TRYING TO GIVE OPTION TO RESET BOARD WHEN YOU HIT A BOMB.
COULDN'T MAKE IT WORK
        ...
        document.getElementById('bigger').addEventListener('click', makeBiggerBoard(evt))
        document.getElementById('smaller').addEventListener('click', makeSmallerBoard(evt))
*/
    return;
  }
  setInnerHTML(cell)
